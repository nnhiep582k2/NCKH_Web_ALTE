...
const itemsCol = document.querySelectorAll('.property__list-body .property__list-line .property__img');
const LinkPropertyItems = document.querySelectorAll('.property__list-line .property__items a');
...
displayItemFull.addEventListener('click', () => {
    ...
    for (let index = 0; index < LinkPropertyItems.length; index++) {
        const element = LinkPropertyItems[index];
        element.style.height = '100%';
        element.style.width = '100%';
    }

    for (let index = 0; index < itemsCol.length; index++) {
        const element = itemsCol[index];
        element.classList.add('col-lg-6', 'col-md-6', 'col-sm-12', 'col-xs-12');
    }
...
displayColItems.addEventListener('click', () => {
    ...
    for (let index = 0; index < heightImgItems.length; index++) {
        ...
        heightImgItems[index].style.width = '100%';
    }
